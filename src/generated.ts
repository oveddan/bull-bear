// Generated by @wagmi/cli@0.1.11 on 3/14/2023 at 12:13:28 AM
import {
  useNetwork,
  useContract,
  UseContractConfig,
...
/**
 * -
 * - [__View Contract on Base Goerli Basescan__](https://goerli.basescan.org/address/0xc66611e6c3d042c7c0abed228620a875dcf384f4)
 */
export const bullBearABI = [
  {
    ...
    inputs: [
      ...
      { name: '_modelUrl', internalType: 'string', type: 'string' },
      { name: '_initialBehaveGraphURI', internalType: 'string', type: 'string' }
    ]
  },
  {
    type: 'error',
  ...
  },
  {
    ...
    type: 'function',
    inputs: [],
    name: 'modelAndGraphUrls',
    outputs: [
      {
        name: '',
        internalType: 'struct Urls',
        type: 'tuple',
        components: [
          { name: 'baseUrl', internalType: 'string', type: 'string' },
          { name: 'modelUrl', internalType: 'string', type: 'string' },
          { name: 'behaveGraphUrl', internalType: 'string', type: 'string' }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    type: 'function',
    inputs: [
      { name: '_behaveGraphURI', internalType: 'string', type: 'string' }
    ],
    name: 'setBehaveGraphURI',
    outputs: []
  },
  {
    stateMutability: 'view',
...
export const bullBearAddress = {
  31337: '0xD84379CEae14AA33C123Af12424A37803F885889',
  84531: '0xc66611e6C3d042c7c0aBeD228620a875Dcf384f4',
  534353: '0xAfa015Ac9233aA4dA147e4AC9C7811C79e8cc6d5'
} as const;
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"behaveGraphURI"`.
 *
 * -
 * - [__View Contract on Base Goerli Basescan__](https://goerli.basescan.org/address/0xc66611e6c3d042c7c0abed228620a875dcf384f4)
 */
export function useBullBearBehaveGraphUri<
  TSelectData = ReadContractResult<typeof bullBearABI, 'behaveGraphURI'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'behaveGraphURI', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"modelAndGraphUrls"`.
 *
 * -
 * - [__View Contract on Base Goerli Basescan__](https://goerli.basescan.org/address/0xc66611e6c3d042c7c0abed228620a875dcf384f4)
 */
export function useBullBearModelAndGraphUrls<
  TSelectData = ReadContractResult<typeof bullBearABI, 'modelAndGraphUrls'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'modelAndGraphUrls', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractRead({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'modelAndGraphUrls',
    ...config
  } as UseContractReadConfig<
    typeof bullBearABI,
    'modelAndGraphUrls',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"modelURI"`.
 *
 * -
 * - [__View Contract on Base Goerli Basescan__](https://goerli.basescan.org/address/0xc66611e6c3d042c7c0abed228620a875dcf384f4)
 */
export function useBullBearModelUri<
  TSelectData = ReadContractResult<typeof bullBearABI, 'modelURI'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'modelURI', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractRead({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'modelURI',
    ...config
  } as UseContractReadConfig<typeof bullBearABI, 'modelURI', TSelectData>);
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"setBehaveGraphURI"`.
 *
 * -
 * - [__View Contract on Base Goerli Basescan__](https://goerli.basescan.org/address/0xc66611e6c3d042c7c0abed228620a875dcf384f4)
 */
export function useBullBearSetBehaveGraphUri<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bullBearAddress
>(
  config: TMode extends 'prepared'
    ...
    : UseContractWriteConfig<TMode, typeof bullBearABI, 'setBehaveGraphURI'> & {
        abi?: never;
        address?: never;
        chainId?: TChainId;
        functionName?: 'setBehaveGraphURI';
  ...
  const { chain } = useNetwork();
  const chainId = config.chainId ?? chain?.id;
  return useContractWrite<TMode, typeof bullBearABI, 'setBehaveGraphURI'>({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'setBehaveGraphURI',
    ...config
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"setBehaveGraphURI"`.
 *
 * -
 * - [__View Contract on Base Goerli Basescan__](https://goerli.basescan.org/address/0xc66611e6c3d042c7c0abed228620a875dcf384f4)
 */
export function usePrepareBullBearSetBehaveGraphUri(
  config: Omit<
    UsePrepareContractWriteConfig<typeof bullBearABI, 'setBehaveGraphURI'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return usePrepareContractWrite({
    ...
    functionName: 'setBehaveGraphURI',
    ...config
  } as UsePrepareContractWriteConfig<typeof bullBearABI, 'setBehaveGraphURI'>);
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link bullBearABI}__ and `eventName` set to `"Petted"`.
 *
 * -
 * - [__View Contract on Base Goerli Basescan__](https://goerli.basescan.org/address/0xc66611e6c3d042c7c0abed228620a875dcf384f4)
 */
export function useBullBearPettedEvent(
  config: Omit<
    UseContractEventConfig<typeof bullBearABI, 'Petted'>,
    'abi' | 'address' | 'eventName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractEvent({
    ...
    eventName: 'Petted',
    ...config
  } as UseContractEventConfig<typeof bullBearABI, 'Petted'>);
}
