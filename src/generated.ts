// Generated by @wagmi/cli@0.1.11 on 3/3/2023 at 11:21:51 AM
import {
  useNetwork,
  useContract,
  UseContractConfig,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"happiness"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearHappiness<
  TSelectData = ReadContractResult<typeof bullBearABI, 'happiness'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'happiness', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractRead({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'happiness',
    ...config
  } as UseContractReadConfig<typeof bullBearABI, 'happiness', TSelectData>);
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"happinessWhenWithdrawn"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearHappinessWhenWithdrawn<
  TSelectData = ReadContractResult<typeof bullBearABI, 'happinessWhenWithdrawn'>
>(
  config: Omit<
    UseContractReadConfig<
      typeof bullBearABI,
      'happinessWhenWithdrawn',
      TSelectData
    >,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
  ...
  return useContractRead({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'happinessWhenWithdrawn',
    ...config
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"lastWithdrawn"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearLastWithdrawn<
  TSelectData = ReadContractResult<typeof bullBearABI, 'lastWithdrawn'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'lastWithdrawn', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractRead({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'lastWithdrawn',
    ...config
  } as UseContractReadConfig<typeof bullBearABI, 'lastWithdrawn', TSelectData>);
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"maxSupply"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearMaxSupply<
  TSelectData = ReadContractResult<typeof bullBearABI, 'maxSupply'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'maxSupply', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractRead({
    ...
    ...config
  } as UseContractReadConfig<typeof bullBearABI, 'maxSupply', TSelectData>);
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"proxiableUUID"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearProxiableUuid<
  TSelectData = ReadContractResult<typeof bullBearABI, 'proxiableUUID'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'proxiableUUID', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractRead({
    ...
    ...config
  } as UseContractReadConfig<typeof bullBearABI, 'proxiableUUID', TSelectData>);
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"withdrawals"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearWithdrawals<
  TSelectData = ReadContractResult<typeof bullBearABI, 'withdrawals'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'withdrawals', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractRead({
    ...
    ...config
  } as UseContractReadConfig<typeof bullBearABI, 'withdrawals', TSelectData>);
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"initialize"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearInitialize<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bullBearAddress
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof bullBearABI, 'initialize'>['abi'],
        'initialize'
      > & { address?: Address; chainId?: TChainId; functionName?: 'initialize' }
    : UseContractWriteConfig<TMode, typeof bullBearABI, 'initialize'> & {
        abi?: never;
        address?: never;
        chainId?: TChainId;
  ...
  const { chain } = useNetwork();
  const chainId = config.chainId ?? chain?.id;
  return useContractWrite<TMode, typeof bullBearABI, 'initialize'>({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'initialize',
    ...config
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"setBaseUri"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearSetBaseUri<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bullBearAddress
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof bullBearABI, 'setBaseUri'>['abi'],
        'setBaseUri'
      > & { address?: Address; chainId?: TChainId; functionName?: 'setBaseUri' }
    : UseContractWriteConfig<TMode, typeof bullBearABI, 'setBaseUri'> & {
        abi?: never;
        address?: never;
        chainId?: TChainId;
  ...
  const { chain } = useNetwork();
  const chainId = config.chainId ?? chain?.id;
  return useContractWrite<TMode, typeof bullBearABI, 'setBaseUri'>({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'setBaseUri',
    ...config
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"upgradeTo"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearUpgradeTo<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bullBearAddress
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof bullBearABI, 'upgradeTo'>['abi'],
        'upgradeTo'
      > & { address?: Address; chainId?: TChainId; functionName?: 'upgradeTo' }
    : UseContractWriteConfig<TMode, typeof bullBearABI, 'upgradeTo'> & {
        abi?: never;
        address?: never;
        chainId?: TChainId;
  ...
  const { chain } = useNetwork();
  const chainId = config.chainId ?? chain?.id;
  return useContractWrite<TMode, typeof bullBearABI, 'upgradeTo'>({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'upgradeTo',
    ...config
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"upgradeToAndCall"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearUpgradeToAndCall<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bullBearAddress
>(
  config: TMode extends 'prepared'
    ...
    : UseContractWriteConfig<TMode, typeof bullBearABI, 'upgradeToAndCall'> & {
        abi?: never;
        address?: never;
        chainId?: TChainId;
        functionName?: 'upgradeToAndCall';
  ...
  const { chain } = useNetwork();
  const chainId = config.chainId ?? chain?.id;
  return useContractWrite<TMode, typeof bullBearABI, 'upgradeToAndCall'>({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'upgradeToAndCall',
    ...config
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"initialize"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function usePrepareBullBearInitialize(
  config: Omit<
    UsePrepareContractWriteConfig<typeof bullBearABI, 'initialize'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return usePrepareContractWrite({
    ...
    functionName: 'initialize',
    ...config
  } as UsePrepareContractWriteConfig<typeof bullBearABI, 'initialize'>);
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"setBaseUri"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function usePrepareBullBearSetBaseUri(
  config: Omit<
    UsePrepareContractWriteConfig<typeof bullBearABI, 'setBaseUri'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return usePrepareContractWrite({
    ...
    functionName: 'setBaseUri',
    ...config
  } as UsePrepareContractWriteConfig<typeof bullBearABI, 'setBaseUri'>);
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"upgradeTo"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function usePrepareBullBearUpgradeTo(
  config: Omit<
    UsePrepareContractWriteConfig<typeof bullBearABI, 'upgradeTo'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return usePrepareContractWrite({
    ...
    functionName: 'upgradeTo',
    ...config
  } as UsePrepareContractWriteConfig<typeof bullBearABI, 'upgradeTo'>);
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"upgradeToAndCall"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function usePrepareBullBearUpgradeToAndCall(
  config: Omit<
    UsePrepareContractWriteConfig<typeof bullBearABI, 'upgradeToAndCall'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return usePrepareContractWrite({
    ...
    functionName: 'upgradeToAndCall',
    ...config
  } as UsePrepareContractWriteConfig<typeof bullBearABI, 'upgradeToAndCall'>);
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link bullBearABI}__ and `eventName` set to `"AdminChanged"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearAdminChangedEvent(
  config: Omit<
    UseContractEventConfig<typeof bullBearABI, 'AdminChanged'>,
  ...
  return useContractEvent({
    ...
    ...config
  } as UseContractEventConfig<typeof bullBearABI, 'AdminChanged'>);
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link bullBearABI}__ and `eventName` set to `"BeaconUpgraded"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearBeaconUpgradedEvent(
  config: Omit<
    UseContractEventConfig<typeof bullBearABI, 'BeaconUpgraded'>,
    'abi' | 'address' | 'eventName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractEvent({
    ...
    ...config
  } as UseContractEventConfig<typeof bullBearABI, 'BeaconUpgraded'>);
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link bullBearABI}__ and `eventName` set to `"Initialized"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearInitializedEvent(
  config: Omit<
    UseContractEventConfig<typeof bullBearABI, 'Initialized'>,
    'abi' | 'address' | 'eventName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractEvent({
    ...
    ...config
  } as UseContractEventConfig<typeof bullBearABI, 'Initialized'>);
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link bullBearABI}__ and `eventName` set to `"Upgraded"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearUpgradedEvent(
  config: Omit<
    UseContractEventConfig<typeof bullBearABI, 'Upgraded'>,
    'abi' | 'address' | 'eventName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractEvent({
    ...
    eventName: 'Upgraded',
    ...config
  } as UseContractEventConfig<typeof bullBearABI, 'Upgraded'>);
}
