// Generated by @wagmi/cli@0.1.11 on 3/3/2023 at 1:36:03 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const bullBearABI = [
  ...
  },
  {
    ...
    name: 'bullBearFood',
    outputs: [
      { name: '', internalType: 'contract BullBearFood', type: 'address' }
    ]
  },
  {
    stateMutability: 'view',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bullBearABI}__ and `functionName` set to `"bullBearFood"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x1A61839Eb5fC6eBBcAe01eD5E79062E598792Dac)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x78991BB1D194C1235fe285240af8489CFA552151)
 * -
 */
export function useBullBearBullBearFood<
  TSelectData = ReadContractResult<typeof bullBearABI, 'bullBearFood'>
>(
  config: Omit<
    UseContractReadConfig<typeof bullBearABI, 'bullBearFood', TSelectData>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bullBearAddress } = {} as any
) {
  const { chain } = useNetwork();
  ...
  return useContractRead({
    abi: bullBearABI,
    address: bullBearAddress[chainId as keyof typeof bullBearAddress],
    functionName: 'bullBearFood',
    ...config
  } as UseContractReadConfig<typeof bullBearABI, 'bullBearFood', TSelectData>);
}
